  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 md:py-28 from-zinc-50 to-white">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="font-heading text-4xl md:text-5xl font-bold mb-6">Blog & Insights</h1>
      ...
      <section className="py-20">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            <h2 className="font-heading text-3xl font-bold mb-4 md:mb-0">Latest Articles</h2>
              ...
              <Card key={post.id} className="overflow-hidden border shadow-sm h-full flex flex-col">
                ...
                <CardContent className="flex-1 p-6">
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <span className="text-xs text-neutral-900">{post.date}</span>
                  </div>
                ...
                <CardFooter className="px-6 pb-6 pt-0 flex items-center justify-between">
                  ...
                  <span className="text-xs text-neutral-900">{post.readTime}</span>
                </CardFooter>
              </Card>
            ))}
          </div>
      ...
      <section className="py-20 ">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-heading text-3xl font-bold mb-4">Subscribe to Our Newsletter</h2>
            <p className="text-xl text-neutral-900 mb-8">
