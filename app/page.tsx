...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="py-20 md:py-32 from-zinc-50 to-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-3/5 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="p-5 rounded-lg border border-zinc-200 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300">
                  <h3 className="text-xl font-semibold mb-3 flex items-center">
                    <div className="h-8 w-1 mr-3 rounded-full"></div>
      ...
      <section className="py-20 ">
        <div className="container px-4 sm:px-8 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service Card 1 */}
            <div className="rounded-lg p-6 shadow-sm border hover:shadow-md transition-shadow">
            ...
            <div className="rounded-lg p-6 shadow-sm border relative">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-900">CTO, TechCorp Inc.</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 text-primary-foreground">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="w-full lg:w-1/2">
              <div className="text-foreground rounded-lg shadow-lg overflow-hidden">
                <LeadMagnetForm />
              </div>
            </div>
          </div>
