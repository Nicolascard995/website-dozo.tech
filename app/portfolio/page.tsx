  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <Badge variant="outline" className="cursor-pointer hover:hover:text-primary-foreground">
                All Projects
              </Badge>
              <Badge variant="outline" className="cursor-pointer hover:hover:text-primary-foreground">
                AI Solutions
          ...
          <div className="rounded-lg overflow-hidden shadow-sm border">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-6 sm:p-10 flex flex-col justify-center">
                ...
                <h2 className="text-2xl sm:font-heading text-3xl font-bold mb-4">DeepSeek AI Integration for Enterprise Search</h2>
      ...
      <section className="py-20">
        <div className="container px-4 sm:px-8 mx-auto">
          <h2 className="font-heading text-3xl font-bold mb-12">More Projects</h2>
      ...
      <section className="py-20 ">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:font-heading text-4xl font-bold mb-4">Our Project Process</h2>
      ...
      <section className="py-20 ">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:font-heading text-4xl font-bold mb-4">Client Testimonials</h2>
            <p className="text-xl text-neutral-900">Hear what our clients have to say about working with us.</p>
          </div>
            ...
            <div className="rounded-lg p-6 shadow-sm border relative">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-900">CIO, Metropolitan Health</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg p-6 shadow-sm border relative">
              ...
              />
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-900">Head of Security, Global Finance</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 text-primary-foreground">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:font-heading text-4xl font-bold mb-4">Ready to Start Your Project?</h2>
