                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="text-sm leading-tight text-neutral-900">
                            Explora soluciones innovadoras que muestran la
                            implementación de ciencia de datos e IA.
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-neutral-900">
                            Implementaciones avanzadas de Machine Learning y
                            Deep Learning
                          </p>
                        </Link>
                      </NavigationMenuLink>
                    ...
                    <li>
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-neutral-900">
                            Optimización de flujos de trabajo y automatización
                            de procesos
                          </p>
                        </Link>
                      </NavigationMenuLink>
